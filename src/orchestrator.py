...
class ETLOrchestrator:
    ...
    def transform_file(self, taz_path: str, output_dir: Optional[str] = None) -> List[dict]:
        """
    ...
    def transform_directory(self, directory: str, output_dir: Optional[str] = None) -> List[dict]:
        """
        ...
        """
        output = output_dir or self.transformed_dir
        return self.transformer.process_directory(directory, output)
    
    def transform_year(self, year: int, output_dir: Optional[str] = None) -> List[dict]:
        """
        ...
        return self.transform_directory(directory, output_dir)
    ...
    def run_etl_year(self, year: int, download: bool = False, index_to_es: bool = True):
        ...
        # Transform
        documents = self.transform_year(year)
    ...
    def run_etl_years(self, years: List[int], download: bool = False, index_to_es: bool = True):
        """
