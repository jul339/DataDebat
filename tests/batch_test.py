...
def sample_taz_file():
    ...
    """
    return "./data/raw/2022/AN_2022001.taz"
...
class TestMetadataConsistency:
    ...
    def test_publication_numero_matches(self, es_client, index_name, parsed_xml_data):
        ...
        query = {
            "query": {
                "term": {"publication_numero": expected_pub_num}
            },
            "size": 1
        }
    ...
    def test_legislature_matches(self, es_client, index_name, parsed_xml_data):
        ...
        query = {
            "query": {
                "term": {"legislature": expected_legislature}
            },
            "size": 1
        }
